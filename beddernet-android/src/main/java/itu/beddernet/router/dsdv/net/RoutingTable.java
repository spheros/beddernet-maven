/**
 * This class is the Routing table itself, holds a collection of RoutingTableEntry objects.
 * It also manages all maintenance of the table
 */
...
public class RoutingTable implements Observer {
	...
	public Vector<RoutingTableEntry> getRoutesAsVector() {
		...
		synchronized (rTable) {
			for (Enumeration<RoutingTableEntry> e = rTable.elements(); e.hasMoreElements();) {
